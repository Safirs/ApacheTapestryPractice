...
@Configuration
@ComponentScan({ "com.example.furniture" })
    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.example.furniture");
                servletContext.setInitParameter("tapestry.development-modules", "com.example.furniture.services.DevelopmentModule");
